...
<img src="./images/create-a-patch-for-cluster-machines-1.png" alt=""/>
...
<img src="./images/create-a-patch-for-cluster-machines-2.png" alt=""/>

Pick the specific machine or class of machines from the “Patch Target” dropdown:

<img src="./images/create-a-patch-for-cluster-machines-3.png" alt=""/>

Type in the desired config patch:

<img src="./images/create-a-patch-for-cluster-machines-4.png" alt=""/>
