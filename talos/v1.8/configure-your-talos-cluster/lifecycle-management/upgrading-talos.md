...
Each Talos version has a corresponding installer image, listed on the release page for the version, for example <a href={`https://github.com/siderolabs/talos/releases/tag/${release_v1_8}`}>{release_v1_8}</a>.
...
## Before Upgrade to {release_v1_8}
...
{`
  ...
  --image ghcr.io/siderolabs/installer:${release_v1_8}
`}
</CodeBlock>
...
* new machine configuration documents: [VolumeConfig](../../reference/configuration/block/volumeconfig), [KubespanEndpointsConfig](../../reference/configuration/network/kubespanendpointsconfig),
  [TrustedRootsConfig](../../reference/configuration/security/trustedrootsconfig)
* new fields in the [v1alpha1](../../reference/configuration/v1alpha1/config) document:
  * [`.machine.nodeAnnotations`](../../reference/configuration/v1alpha1/config#Config.machine)
  * [`.machine.systemDiskEncryption.*.keys.tpm.checkSecurebootStatusOnEnroll](../../reference/configuration/v1alpha1/config#Config.machine.systemDiskEncryption.ephemeral.keys..tpm)
  * [`.machine.network.interfaces.bridge.vlan`](../../reference/configuration/v1alpha1/config#Config.machine.network.interfaces..bridge.vlan)
