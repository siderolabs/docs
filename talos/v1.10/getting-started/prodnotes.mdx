...
If not, please refer to the [Getting Started](./getting-started.mdx) guide for more information.
...
Please see the [kernel docs](../reference/kernel.mdx) getting-started for more information.
...
If the values don't match, you'll need to update your machine configuration..
    ...
    **Note**: Refer to the [Talos CLI reference](../reference/cli.mdx) for additional commands to gather more information about your nodes and cluster.
...
Additionally, you can learn more about [patches](../configure-your-talos-cluster/system-configuration/patching.mdx) from the configuration patches documentation.
