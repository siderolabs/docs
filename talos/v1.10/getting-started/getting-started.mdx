...
- [Set up persistent storage](../../../kubernetes-guides/csi/storage.mdx)
- [Deploy a Metrics Server](../../../kubernetes-guides/monitoring-and-observability/deploy-metrics-server.mdx)
