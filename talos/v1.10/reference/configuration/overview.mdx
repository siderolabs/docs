...
At the moment, majority of the configuration options are within the [v1alpha1](./v1alpha1/config.mdx) document, so
...
* [quick guide to configuration generation](../../getting-started/getting-started.mdx)
* [configuration management in production](../../getting-started/prodnotes.mdx)
