...
At the moment, majority of the configuration options are within the [v1alpha1]("./v1alpha1") document, so
...
* [quick guide to configuration generation](../../introduction/getting-started#configure-talos-linux)
* [configuration management in production](../../introduction/prodnotes#configure-talos)
* [configuration patches](../../configure-your-talos-cluster/system-configuration/patching.mdx)
* [editing live machine configuration](../../configure-your-talos-cluster/system-configuration/editing-machine-configuration.mdx)
