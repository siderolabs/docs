...
The list of variables supported by the `talos.config.oauth.extra_variable` parameter is same as the [list of variables](../reference/kernel.mdx#talosconfig) supported by the `talos.config` parameter.
