...
You can get more insights on SELinux policy inner workings in the corresponding section of the [Developing Talos](../build-and-extend-talos/custom-images-and-development/developing-talos.mdx#selinux-policy-debugging-and-development) page.
