...
> Note: if using [Talos API access from Kubernetes](../../../kubernetes-guides/advanced-guides/talos-api-access-from-k8s.mdx) feature, pods might need to be restarted manually to pick up new `talosconfig`.
