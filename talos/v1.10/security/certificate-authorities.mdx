...
Append additional certificate authorities to the system's trusted certificate store by [patching](../configure-your-talos-cluster/system-configuration/patching.mdx) the machine configuration with the following
[document](../reference/configuration/security/trustedrootsconfig.mdx):
