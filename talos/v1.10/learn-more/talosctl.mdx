...
![Endpoints and Nodes](./images/talosctl-endpoints-and-nodes.png)
...
Please see the [CLI reference](../reference/cli.mdx) for the entire list of commands which are available from `talosctl`.
