...
* <a href={`https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release}/metal-amd64.iso`}> amd64 ISO (for Talos {release}, "vanilla" schematic) </a>

*  <a href={`https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release}/aws-arm64.raw.xz`}> arm64 AWS image (for Talos {release}, "vanilla" schematic) </a>

* <a href={`https://pxe.factory.talos.dev/pxe/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release}/metal-amd64`}> amd64 PXE boot script (for Talos {release}, "vanilla" schematic)  </a>

* Talos `<code>` installer image (for Talos {release}, “vanilla” schematic, architecture is detected automatically):  

<CodeBlock lang="sh">
{`factory.talos.dev/installer/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba:${release}`}
</CodeBlock>
