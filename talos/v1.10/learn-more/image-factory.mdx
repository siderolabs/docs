...
See [Boot Assets](../platform-specific-installations/boot-assets.mdx#image-factory) for an example of how to use the Image Factory to boot and upgrade Talos on different platforms.
