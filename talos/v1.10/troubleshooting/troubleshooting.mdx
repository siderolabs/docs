...
In this guide we assume that Talos is configured with default features enabled, such as [Discovery Service](../configure-your-talos-cluster/system-configuration/discovery.mdx) and [KubePrism](../../../kubernetes-guides/advanced-guides/kubeprism.mdx).
