...
For a list of Kubernetes versions compatible with each Talos release, see the [Support Matrix](../getting-started/support-matrix.mdx).

For upgrading the Talos Linux operating system, see [Upgrading Talos](../configure-your-talos-cluster/lifecycle-management/upgrading-talos.mdx)
