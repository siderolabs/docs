...
* `https://<controlplane-address>:<api-server-port>` for every controlplane machine (based on the information from [Cluster Discovery](../configure-your-talos-cluster/system-configuration/discovery.mdx))
