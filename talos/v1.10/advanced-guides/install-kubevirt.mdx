...
When you want to leverage [Multus](../../../kubernetes-guides/cni/multus.mdx) to give your virtual machines direct access to your node network, your bridge needs to be configured properly.
...
You can install the `local-path-provisioner` by following [this guide](../../../kubernetes-guides/csi/local-storage.mdx).
...
In this example we will create a virtual machine that is bound to the bridge interface with the help of [Multus](../../../kubernetes-guides/cni/multus.mdx).
