...
import { release_branch } from '/snippets/custom-variables.mdx';
...
First, you might need to prepare the build environment, follow the [Building Custom Images](./building-images.mdx) guide.
...
Follow the [Building Custom Images](./building-images.mdx) guide to set up the Talos source code checkout.
...
Follow the [Boot Assets](../../platform-specific-installations/boot-assets.mdx) guide to build Talos boot assets you might need to boot Talos: ISO, `installer` image, etc.
