...
This may be done via editing the `controlplane.yaml` file before it is applied to the control plane nodes, by [editing the machine config](../configure-your-talos-cluster/system-configuration/editing-machine-configuration.mdx), or by [patching the machine config](../configure-your-talos-cluster/system-configuration/patching.mdx).
