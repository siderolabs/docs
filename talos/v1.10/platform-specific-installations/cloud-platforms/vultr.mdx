...
Talos Linux can be PXE-booted on Vultr using [Image Factory](../../learn-more/image-factory.mdx), using the `vultr` platform: e.g.

<CodeBlock lang="sh">
{
`https://pxe.factory.talos.dev/pxe/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release}/vultr-amd64` 
...
While the cluster goes through the bootstrapping process and beings to self-manage, the `talosconfig` can be updated with the [endpoints and nodes](../../learn-more/talosctl.mdx#endpoints-and-nodes).
