...
Endpoint selection has been further documented [here](../../getting-started/getting-started.mdx#decide-the-kubernetes-endpoint).
...
Depending on the Kubernetes version you want to run, you might need to select a different Talos version, as not all versions are compatible.
 You can find the support matrix [here](../../getting-started/support-matrix.mdx).

Optionally, you can specify [machine configuration patches](../../configure-your-talos-cluster/system-configuration/patching.mdx#configuration-patching-with-talosctl-cli)
...
cluster if you are not careful [(further documentation)](../../getting-started/getting-started.mdx#configure-your-talosctl-client).
