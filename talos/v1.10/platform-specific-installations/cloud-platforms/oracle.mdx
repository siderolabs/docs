...
2. Download the disk image artifact (e.g: <a href={`https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release}/oracle-arm64.raw.xz`}>
  Oracle arm64
</a>)
...
Optionally, you can specify [machine configuration patches](../../configure-your-talos-cluster/system-configuration/patching.mdx#configuration-patching-with-talosctl-cli) which will be applied during the config generation.
