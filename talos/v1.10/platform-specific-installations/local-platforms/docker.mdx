...
The machine configuration submitted to the container should have a [host DNS feature](../../reference/configuration/v1alpha1/config.mdx#Config.machine.features.hostDNS) enabled with `forwardKubeDNSToHost` enabled.
