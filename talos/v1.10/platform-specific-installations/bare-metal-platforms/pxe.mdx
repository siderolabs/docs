...
There are more detailed guides for PXE booting using [Matchbox](./matchbox.mdx).
...
Please follow the [getting started guide](../../getting-started/getting-started.mdx) for the generic steps on how to install Talos.

See [kernel parameters reference](../../reference/kernel.mdx) for the list of kernel parameters supported by Talos.
...
> Note: The `talos.config` kernel parameter supports other substitution variables, see [kernel parameters reference](../../reference/kernel.mdx) for the full list.

PXE booting can be also performed via [Image Factory](../../learn-more/image-factory.mdx).
