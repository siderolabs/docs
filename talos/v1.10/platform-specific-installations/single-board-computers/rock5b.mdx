...
- follow [Installation/talosctl](../../getting-started/talosctl.mdx ) to intall `talosctl`
- an SD card
...
[getting started guide](../../getting-started/getting-started.mdx#configure-talos-linux)
...
[Disk Management](../../configure-your-talos-cluster/storage-and-disk-management/disk-management.mdx).
