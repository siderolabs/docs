...
All supported config parameters are described in the [Machine Config Reference](../reference/configuration/v1alpha1/config.mdx#Config.machine.network.interfaces..wireguard).
