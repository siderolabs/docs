...
Use the [EthernetConfig](../reference/configuration/network/ethernetconfig.mdx) document to configure Ethernet settings.
You can append the machine config document to the machine configuration (separating with `---`), or apply it as a [machine configuration patch](../configure-your-talos-cluster/system-configuration/patching.mdx).
