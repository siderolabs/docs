...
When enabled, Talos Linux uses [discovery](../configure-your-talos-cluster/system-configuration/discovery.mdx) data to resolve Talos cluster member names to IP addresses:
