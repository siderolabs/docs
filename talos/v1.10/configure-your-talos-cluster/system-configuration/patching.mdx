...
> Note: Talos 1.5+ supports [multi-document machine configuration](../../reference/configuration/overview.mdx).
...
When patching a [multi-document machine configuration](../../reference/configuration/overview.mdx), following rules apply:
