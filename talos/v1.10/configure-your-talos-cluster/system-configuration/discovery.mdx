...
> Note: An enabled discovery service is required for [KubeSpan](../../networking/kubespan.mdx) to function correctly.
...
Node identity resource is preserved in the [STATE](../../learn-more/architecture.mdx#file-system-partitions) partition in `node-identity.yaml` file.
