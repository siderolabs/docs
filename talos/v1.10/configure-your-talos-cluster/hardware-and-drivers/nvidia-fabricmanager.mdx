...
import { release_v1_10, nvidia_driver_release, nvidia_container_toolkit_release } from '/snippets/custom-variables.mdx';
...
<CodeBlock lang="sh">
{`
ghcr.io/siderolabs/nvidia-open-gpu-kernel-modules-lts:${nvidia_driver_release}-${release_v1_10}
