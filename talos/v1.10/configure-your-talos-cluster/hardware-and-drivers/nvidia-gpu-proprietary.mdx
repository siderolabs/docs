...
> To build a NVIDIA driver version not published by SideroLabs follow the instructions [here]("../../../v1.4/talos-guides/configuration/nvidia-gpu-proprietary")

Create the [boot assets](../../platform-specific-installations/boot-assets.mdx) which includes the system extensions mentioned above (or create a custom installer and perform a machine upgrade if Talos is already installed).
