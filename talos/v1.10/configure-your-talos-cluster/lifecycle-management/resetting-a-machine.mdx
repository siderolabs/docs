...
> It might be more practical to only wipe the [STATE](../../learn-more/architecture.mdx#file-system-partitions) and [EPHEMERAL](../../learn-more/architecture.mdx#file-system-partitions) partitions on a cloud VM if not booting via `iPXE`.
