...
<Info>Omni is released under the BUSL. Using Omni for production use requires a commercial license. Contact [sales@SideroLabs.com](mailto:sales@siderolabs.com) for more information. Non-production use, such as using Omni for a home lab, does not require a license.</Info>
...
[Sign Up](https://www.siderolabs.com/omni-signup) to start your free 2 week trial and start exploring today!
...
<Info>Omni and Talos Linux may utilize KubeSpan, covered under U.S. Patent 11,968,180</Info>
