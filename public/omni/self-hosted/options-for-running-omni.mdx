---
title: Options for Running Omni
description: Learn about the options for running Omni, from fully managed hosted to self-hosted configurations, and choose the right setup for your environment.
---

import { version } from '/snippets/custom-variables.mdx';

Omni can be run in several different environments depending on your operational requirements. This guide explains how Omni behaves in each environment and what level of availability each option provides.
...
<Note>Using Omni in production requires a commercial license. For more information, contact [sales@SideroLabs.com](mailto:sales@siderolabs.com). Non-production use, such as running Omni in a home lab, does not require a license.</Note>
