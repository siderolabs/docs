...
Because Omni does not have any user authentication we need to add an additional component that handles authentication. Omni supports OIDC and SAML providers, so we can use a variety of different components for this.
