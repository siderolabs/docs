...
Kubernetes clusters deployed on Talos use technologies such as [KubePrism](../../../kubernetes-guides/advanced-guides/kubeprism) and a [discovery service](../../../talos/v1.11//configure-your-talos-cluster/system-configuration/discovery) to make sure the cluster and workloads can run without highly available, external management such as Omni.
