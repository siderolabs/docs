...
<iframe width="560"
    height="315"
    src="https://www.youtube.com/embed/h1eVe-i__pc"
    title="Omni Infrastructure Providers"
    frameborder="0"
    allow="accelerometer;
...
* [Truenas provider](https://github.com/bearbinary/omni-infra-provider-truenas)
...
<img src="./images/infrastructure-providers-architecture.png" alt="Infrastructure provider architecture"/>
