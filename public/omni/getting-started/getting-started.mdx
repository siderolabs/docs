...
You can download this Talos Omni image from either the Omni UI or the CLI:
...
2. Click **Download Installation Media** to open the <a href={`../../talos/${version}/learn-more/image-factory`}>Image Factory</a>.

![image]()

3. In the Image Factory, choose the options required to build the image for your machine.
    ...
    You can configure:
      ...
      - System extensions or other customizations

4. Download the image that matches your configuration.

![image]()

<Note>Click **Save** in the bottom-right corner to store your selected options as a preset for future use.</Note>
