...
Operations such as `talosctl reset` must be performed through the Omni UI or API.

Users with at least the [Operator](https://omni.siderolabs.com/reference/acls#role) role can still run the following commands:
