...
<Tabs>
  <Tab title="UI">
    ...
    - **Features**: Optionally enable additional features such as [disk encryption](../security-and-authentication/omni-kms-disk-encryption) or [workload service proxying](../cluster-management/expose-an-http-service-from-a-cluster).
