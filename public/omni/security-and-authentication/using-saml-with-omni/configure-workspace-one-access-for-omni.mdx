...
<img src="./images/configure-workspace-one-access-web-apps-resources.png" alt=""/>
...
<img src="./images/configure-workspace-one-access-definition.png" alt=""/>
...
<img src="./images/configure-workspace-one-access-single-sign-on-authentication-type-settings.png" alt=""/>
...
<img src="./images/configure-workspace-one-access-single-sign-on-relay-state-url.png" alt=""/>
...
<img src="./images/configure-workspace-one-access-custom-attribute-mapping.png" alt=""/>

Click _**Next**_ to continue and select the access policy as required by your organization.

<img src="./images/configure-workspace-one-access-access-policies.png" alt=""/>

Now it’s time to click the _**Save & Assign**_ button and permit the Users and Groups allowed to login to Omni.

<img src="./images/configure-workspace-one-access-cancel-back-save.png" alt=""/>
...
<img src="./images/configure-workspace-one-access-application-omni-updated.png" alt=""/>

Finally, obtain the _**IdP**_ Metadata URL by clicking on _**Settings**_ and then the _**Copy URL**_ link.

<img src="./images/configure-workspace-one-access-web-apps-new.png" alt=""/>

<Info>
This is the URL that will be used by Omni in the command line arguments in the next section.
</Info>

<img src="./images/configure-workspace-one-access-settings-download-saml-metadata.png" alt=""/>
