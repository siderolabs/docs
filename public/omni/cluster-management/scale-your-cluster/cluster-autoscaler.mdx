...
> **Note**: After downloading, some platforms require you to upload the generated file to create a bootable image, for example, an [AMI in AWS](../../../talos/v1.11/platform-specific-installations/cloud-platforms/aws#create-your-own-amis), [a Managed Image in Azure](../../../talos/v1.11/platform-specific-installations/cloud-platforms/azure#create-the-image), or a [Custom Image in GCP](../../../talos/v1.11/platform-specific-installations/cloud-platforms/gcp#create-the-image).
