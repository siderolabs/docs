...
| `kubernetes.healthchecks`               | array[Healthcheck]       | List of advanced healthchecks that gate Talos Linux upgrades. See [Gate Talos Upgrades with Healthchecks](../cluster-management/gate-talos-upgrades-with-healthchecks).                                                                                                      |
...
For full usage details and examples, see [Gate Talos Upgrades with Healthchecks](../cluster-management/gate-talos-upgrades-with-healthchecks).
