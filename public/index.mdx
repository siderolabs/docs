...
{/*
  ...
  Announcement gating: a product appears here only once its name is public.
  The hypervisor, containers, and AI sections below are commented out until
  their announcements. When flipping one on:

    1. Uncomment the section.
    2. Update the hero sentence to name the new domain (it lists what the
       page shows, so the promise cannot outrun the page).
    3. Give live cards a real href; coming-soon cards stay unlinked.
...
<div id="docs-home">
  {/* Custom mode strips the logo, tab bar, and CTA from the navbar (only
      search, assistant, and the theme toggle survive), so the homepage
      carries its own brand row. Same links as the navbar in docs.json. */}
  <div className="home-topbar">
    <a className="home-mark" href="/">
      <img className="home-logo-light" src="/images/sidero-light.svg" alt="Sidero" />
      <img className="home-logo-dark" src="/images/sidero-dark.svg" alt="Sidero" />
    </a>
    <span className="home-topbar-spacer" />
    <a className="home-toplink" href="https://www.siderolabs.com/support/">Enterprise Support</a>
    <a className="home-cta" href="https://www.siderolabs.com/omni-signup">Try Talos Omni</a>
  </div>

  <section className="home-hero">
    <h1>Talos Documentation</h1>
    <p className="home-promise">
      Kubernetes on an immutable operating system you manage through an API.
    </p>
  ...
  <div className="home-catalog">
    ...
    {/* HYPERVISOR — uncomment at the TalosCon announcement (or earlier press
        release). Hero sentence gains "virtual machines".
    ...
    <section className="home-domain">
      ...
      <div className="home-grid">
        <a className="home-card home-card--soon">
    ...
    */}
    ...
    {/* CONTAINERS — uncomment when the containers mode is announced. Hero
        sentence gains "containers".
    ...
    */}
    ...
    {/* AI — uncomment when Athena is announced. Hero sentence gains
        "private AI".
