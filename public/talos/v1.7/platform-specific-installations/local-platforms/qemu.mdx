...
For example version {release_v1_7 }:

<CodeBlock lang="sh">
  {`
  curl https://github.com/siderolabs/talos/releases/download/${release_v1_7 }/vmlinuz-amd64 -L -o _out/vmlinuz-amd64
  curl https://github.com/siderolabs/talos/releases/download/${release_v1_7 }/initramfs-amd64.xz -L -o _out/initramfs-amd64.xz
  `}
</CodeBlock>
