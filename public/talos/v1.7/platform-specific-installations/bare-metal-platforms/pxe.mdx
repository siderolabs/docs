...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/bare-metal-platforms/pxe
---
...
There are two more detailed guides for PXE booting using [Matchbox](./matchbox) and [Digital Rebar](./digital-rebar).
