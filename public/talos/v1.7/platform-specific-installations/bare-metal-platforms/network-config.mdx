...
<CodeBlock lang="sh">
{`
docker run --rm -i ghcr.io/siderolabs/imager:${release_v1_7 } iso --arch amd64 --tar-to-stdout --meta 0xa='{...}' | tar xz
docker run --rm -i --privileged ghcr.io/siderolabs/imager:${release_v1_7 } image --platform metal --arch amd64 --tar-to-stdout --meta 0xa='{...}' | tar xz
`}
</CodeBlock>
