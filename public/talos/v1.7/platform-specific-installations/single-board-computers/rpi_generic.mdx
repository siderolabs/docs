...
<CodeBlock lang="sh">
  {`
curl -LO https://factory.talos.dev/image/ee21ef4a5ef808a9b7484cc0dda0f25075021691c8c09a276591eedb638ea1f9/${release_v1_7 }/metal-arm64.raw.xz
...
<CodeBlock lang="sh">
  {`
talosctl -n <node IP or DNS name> upgrade --image=factory.talos.dev/installer/ee21ef4a5ef808a9b7484cc0dda0f25075021691c8c09a276591eedb638ea1f9:${release_v1_7 }
  `}
</CodeBlock>
...
- <a href= {`https://factory.talos.dev/image/0db665edfda21c70194e7ca660955425d16cec2aa58ff031e2abf72b7c328585/${release_v1_7}/metal-arm64.raw.xz`}> Download it and burn to a boot media </a>
...
<CodeBlock lang="sh">
  {`
$ crane export ghcr.io/siderolabs/extensions:${release_v1_7 } | tar x -O image-digests | grep -E 'vc4'
...
<CodeBlock lang="sh">
  {`
$ docker run --rm -t -v $PWD/_out:/out -v /dev:/dev --privileged ghcr.io/siderolabs/imager:${release_v1_7 } rpi_generic \\
  --arch arm64 \\
...
<CodeBlock lang="sh">
  {`
$ docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_7 } installer \\
  --arch arm64 \\
  --overlay-image ghcr.io/siderolabs/sbc-raspberrypi:v0.1.0@sha256:849ace01b9af514d817b05a9c5963a35202e09a4807d12f8a3ea83657c76c863 \\
  --overlay-name=rpi_generic \\
  --overlay-option="configTxt=$(cat <<EOF
