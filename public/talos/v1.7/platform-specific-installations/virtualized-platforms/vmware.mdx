...
<CodeBlock lang="sh">
  {`
curl -fsSL "https://raw.githubusercontent.com/siderolabs/talos/master/website/content/${version_v1_7}/talos-guides/install/virtualized-platforms/vmware/vmware.sh" | sed s/latest/${release_v1_7 }/ > vmware.sh
  `}
</CodeBlock>
