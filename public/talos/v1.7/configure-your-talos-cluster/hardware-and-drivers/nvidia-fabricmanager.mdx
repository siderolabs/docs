...
import { release_v1_7 , nvidia_driver_release_v1_7, nvidia_container_toolkit_release_v1_7 } from '/snippets/custom-variables.mdx';
...
<CodeBlock lang="sh">
{`
ghcr.io/siderolabs/nvidia-open-gpu-kernel-modules:${nvidia_driver_release_v1_7}-${release_v1_7 }
ghcr.io/siderolabs/nvidia-container-toolkit:${nvidia_driver_release_v1_7}-${nvidia_container_toolkit_release_v1_7}
ghcr.io/siderolabs/nvidia-fabricmanager:${nvidia_driver_release_v1_7}
