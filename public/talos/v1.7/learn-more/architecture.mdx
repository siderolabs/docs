...
canonical: https://docs.siderolabs.com/talos/latest/learn-more/architecture
---
...
`--preserve` option of [`talosctl upgrade`](../reference/cli#talosctl-upgrade) or the `--system-labels-to-wipe` option of [`talosctl reset`](../reference/cli#talosctl-reset)
is used.
