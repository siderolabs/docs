...
1. Creating a keypair, populate an S3 bucket with publicly-accessible OIDC discovery documents, and
...
using the registered IdP, ensure the the role assumption is allowed, and returns credentials.
...
# identify a key. This logic comes from https://github.com/kubernetes/kubernetes/pull/78502, and create
# unique and deterministic outputs across platforms
