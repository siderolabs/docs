...
See [reproducible machine configuration](./reproducible-machine-configuration) for more details.
...
Multiple configuration documents cen be included in the patch using multi-document YAML syntax (`---` separator).
