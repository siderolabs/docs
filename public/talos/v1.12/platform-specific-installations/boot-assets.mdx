...
talosctl upgrade \
  --image \
  factory.talos.dev/metal-installer/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176:<new_version>
...
talosctl upgrade \\
  --image \\
  factory.talos.dev/metal-installer/<new_schematic_id>:${release_v1_12}
`}
</CodeBlock>
...
{`
curl -LO \\
  https://factory.talos.dev/image/d9ff89777e246792e7642abd3220a616afb4e49822382e4213a2e528ab826fe5/${release_v1_12}/aws-amd64.raw.xz
`}
</CodeBlock>
...
talosctl upgrade \\
  --image \\
  factory.talos.dev/aws-installer/<new_schematic_id>:${release_v1_12}
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
crane export ghcr.io/siderolabs/extensions:${release_v1_12} | \\
...
<CodeBlock lang="sh">
{`
crane export ghcr.io/siderolabs/overlays:${release_v1_12} | \\
...
ghcr.io/siderolabs/imager:${release_v1_12} \\
iso \\
--system-extension-image ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_12}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e \\
...
crane push _out/metal-amd64-installer.tar \\
  ghcr.io/<username></username>/installer:${release_v1_12}
`}
</CodeBlock>
...
cat profile.yaml | docker run --rm -i \\
  -v "$PWD/_out:/out" \\
  -v "$PWD/<your-extension>:/<your-extension>" \\
  ghcr.io/siderolabs/imager:${release_v1_12} -
`}
</CodeBlock>
