...
Download the DigitalOcean image `digital-ocean-amd64.raw.gz` from the <a href={`https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_12}/digital-ocean-amd64.raw.gz`}>
  Image Factory
</a>.
