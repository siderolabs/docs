...
1. **Download the image disk** of the Talos version you wish to run:
  ...
  <CodeBlock lang="sh">
    {`
   wget "https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/v${release_v1_12}/scaleway-amd64.raw.zst"
   `}
   </CodeBlock>
