...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/single-board-computers/rpi_generic
---
...
<CodeBlock lang="sh">
  {`
curl -LO https://factory.talos.dev/image/ee21ef4a5ef808a9b7484cc0dda0f25075021691c8c09a276591eedb638ea1f9/${release_v1_12}/metal-arm64.raw.xz
...
<CodeBlock lang="sh">
  {`
talosctl -n <node IP or DNS name> upgrade --image=factory.talos.dev/installer/ee21ef4a5ef808a9b7484cc0dda0f25075021691c8c09a276591eedb638ea1f9:${release_v1_12}
  `}
</CodeBlock>
...
- https://factory.talos.dev/image/0db665edfda21c70194e7ca660955425d16cec2aa58ff031e2abf72b7c328585/${release_v1_12}/metal-arm64.raw.xz (download it and burn to a boot media)
...
<CodeBlock lang="sh">
  {`
talosctl upgrade --image factory.talos.dev/installer/<new_schematic_id>:${release_v1_12}
  `}
</CodeBlock>
...
<CodeBlock lang="sh">
  {`
$ crane export ghcr.io/siderolabs/extensions:${release_v1_12} | tar x -O image-digests | grep -E 'vc4'
...
<CodeBlock lang="sh">
  {`
$ docker run --rm -t -v $PWD/_out:/out -v /dev:/dev --privileged ghcr.io/siderolabs/imager:${release_v1_12} rpi_generic \
  --arch arm64 \
...
<CodeBlock lang="sh">
  {`
$ docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_12} installer \
  --arch arm64 \
  --overlay-image ghcr.io/siderolabs/sbc-raspberrypi:v0.1.0@sha256:849ace01b9af514d817b05a9c5963a35202e09a4807d12f8a3ea83657c76c863 \
  --overlay-name=rpi_generic \
  --overlay-option="configTxt=$(cat <<EOF
...
**NOTE!** GPIO 14 is instructed by the official case fan.  But, when using GPIO 14, you must make sure that you either disable UART (`enable_uart=1`), or alternatively change the pin to e.g. GPIO 4 which is one step away.  [_Pin layout_](https://pinout.xyz).
