...
See the [guide on running Image Factory in air-gapped environments](../../../omni/infrastructure-and-extensions/self-hosted/install-image-factory-on-prem) for more details.
