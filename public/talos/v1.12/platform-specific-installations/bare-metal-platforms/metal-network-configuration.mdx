...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/bare-metal-platforms/metal-network-configuration
---
...
<CodeBlock lang="sh">
{`
docker run --rm -t -v $PWD/_out:/out -v /dev:/dev --privileged ghcr.io/siderolabs/imager:${release_v1_12} metal --meta "0xa=$(cat network.yaml)"
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
$ docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_12} iso --meta "0xa=$(cat network.yaml)"
...
