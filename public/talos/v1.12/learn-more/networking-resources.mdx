...
canonical: https://docs.siderolabs.com/talos/latest/learn-more/networking-resources
---
...
Talos network configuration subsystem is powered by [COSI](./controllers-resources).
...
As API access requires network connection, [`--mode=try`](../configure-your-talos-cluster/system-configuration/editing-machine-configuration)
...
The kernel [command line](../reference/kernel) is parsed for the following options:
