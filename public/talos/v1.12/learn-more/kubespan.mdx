...
canonical: https://docs.siderolabs.com/talos/latest/learn-more/kubespan
---
...
See [discovery service](../configure-your-talos-cluster/system-configuration/discovery) to learn more about the external service.
