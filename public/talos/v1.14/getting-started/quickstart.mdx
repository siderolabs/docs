...
talos-default-controlplane-1   Ready    master   115s   v${k8s_release}   10.5.0.2      <none>        Talos ${release_v1_14}   <host kernel>    containerd://2.1.5
talos-default-worker-1         Ready    <none>   115s   v${k8s_release}   10.5.0.3      <none>        Talos ${release_v1_14}   <host kernel>    containerd://2.1.5
`}
</CodeBlock>
