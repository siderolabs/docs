...
<CodeBlock lang="sh">
{` NAME            STATUS   ROLES           AGE     VERSION             INTERNAL-IP   EXTERNAL-IP   OS-IMAGE                    KERNEL-VERSION   CONTAINER-RUNTIME\ntalos-cfx-nh0   Ready    <none>          2m53s   v${k8s_release}     10.5.13.47    <none>        Talos ${release_v1_14}      <host kernel>    containerd://2.1.6\ntalos-vb5-xfr   Ready    control-plane   2m51s   v${k8s_release}     10.5.13.46    <none>        Talos ${release_v1_14}      <host kernel>    containerd://2.1.6 `}
</CodeBlock>
