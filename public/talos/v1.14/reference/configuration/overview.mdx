...
Settings are steadily moving out of it into their own documents — the [configuration document map](./document-map) shows which document replaces each `v1alpha1` field, and in which release.
