...
canonical: https://docs.siderolabs.com/talos/latest/build-and-extend-talos/cluster-operations-and-maintenance/disaster-recovery
---
...
If a control plane node is up but `etcd` isn't, wipe the node's [EPHEMERAL](../../learn-more/architecture#file-system-partitions) partition to remove the `etcd`
