...
canonical: https://docs.siderolabs.com/talos/latest/build-and-extend-talos/custom-images-and-development/customizing-the-kernel
---
...
import { release_branch_v1_14 } from '/snippets/custom-variables.mdx';
...
cd pkgs
git checkout ${release_branch_v1_14}
`}
</CodeBlock>
