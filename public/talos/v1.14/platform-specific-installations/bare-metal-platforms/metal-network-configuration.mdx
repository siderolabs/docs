...
<CodeBlock lang="sh">
{`
docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_14} metal --meta "0xa=$(cat network.yaml)"
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
$ docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_14} iso --meta "0xa=$(cat network.yaml)"
...
