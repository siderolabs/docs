...
cd /tmp
wget -O /tmp/talos.raw.xz https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_14}/hcloud-amd64.raw.xz
# Replace system
...
{`
#!/usr/bin/env bash
export TALOS_IMAGE_VERSION=${release_v1_14} # You can change to the current version
