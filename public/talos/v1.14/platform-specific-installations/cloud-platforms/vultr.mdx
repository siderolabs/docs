...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/cloud-platforms/vultr
---
...
<CodeBlock lang="sh">
{`
vultr-cli iso create --url https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/ ${release_v1_14}vultr-amd64.iso
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{
`https://pxe.factory.talos.dev/pxe/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_14}/vultr-amd64` 
