...
* <a href={`https://factory.talos.dev/image/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176/${release_v1_14}/metal-amd64.iso`}>
    using ISO image (download it and burn to a CD/DVD or USB stick)
  </a>

* <a href={`https://factory.talos.dev/pxe/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176/${release_v1_14}/metal-amd64`}>
...
machine:
  install:
    image: factory.talos.dev/metal-installer/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176:${release_v1_14}
`}
</CodeBlock>
...
talosctl upgrade \\
  --image \\
  factory.talos.dev/metal-installer/<new_schematic_id>:${release_v1_14}
`}
</CodeBlock>
...
Now we can [download the metal arm64 image](https://factory.talos.dev/image/0db665edfda21c70194e7ca660955425d16cec2aa58ff031e2abf72b7c328585/${release_v1_14}/metal-arm64.raw.xz) (download it and burn to a boot media)
...
{`
curl -LO \\
  https://factory.talos.dev/image/d9ff89777e246792e7642abd3220a616afb4e49822382e4213a2e528ab826fe5/${release_v1_14}/aws-amd64.raw.xz
`}
</CodeBlock>
...
talosctl upgrade \\
  --image \\
  factory.talos.dev/aws-installer/<new_schematic_id>:${release_v1_14}
`}
</CodeBlock>

## Imager

A custom disk image, boot asset can be generated by using the Talos Linux `imager` container: ghcr.io/siderolabs/imager:{release_v1_14}.
...
docker run --rm -t \\
  ...
  -v "$PWD/_out:/out" \\
  ghcr.io/siderolabs/imager:${release_v1_14} \\
...
<CodeBlock lang="sh">
{`
crane export ghcr.io/siderolabs/extensions:${release_v1_14} | \\
...
<CodeBlock lang="sh">
{`
crane export ghcr.io/siderolabs/overlays:${release_v1_14} | \\
...
`}
  ...
  <Tab title="Output">
    <CodeBlock lang="sh">
      {`
        ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_14}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e
...
ghcr.io/siderolabs/imager:${release_v1_14} \\
iso \\
--system-extension-image ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_14}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e \\
...
crane push _out/metal-amd64-installer.tar \\
  ghcr.io/<username></username>/installer:${release_v1_14}
`}
</CodeBlock>
