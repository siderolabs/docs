...
<CodeBlock lang="bash">
  {`curl -L https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_14}/opennebula-amd64.qcow2 \\
...
<CodeBlock lang="bash">
  {`oneimage create --name talos-${release_v1_14} \\
