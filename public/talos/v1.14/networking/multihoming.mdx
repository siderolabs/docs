...
Analogously to etcd, for kubelets this is controlled via the `nodeIP.validSubnets` field of the [`KubeNodeConfig`](../reference/configuration/kubernetes/kubenodeconfig) document.
