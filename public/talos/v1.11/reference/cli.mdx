...
```
  ...
  -i, --input-dir string                         location of pre-generated config files
      ...
      --cni-bin-path strings                     (qemu) search path for CNI binaries (default [/.talos/cni/bin])
      ...
      --cni-cache-dir string                     (qemu) CNI cache directory path (default "/.talos/cni/cache")
      --cni-conf-dir string                      (qemu) CNI config directory path (default "/.talos/cni/conf.d")
      ...
      --install-image string                     (qemu) the installer image to use (default "ghcr.io/siderolabs/installer:v1.11.2")
  ...
  -p, --exposed-ports string                     (docker) Comma-separated list of ports/protocols to expose on init node. Ex -p {"<"}hostPort{">"}:{"<"}containerPort{">"}/{"<"}protocol (tcp or udp){">"}
      --image string                             (docker) the image to use (default "ghcr.io/siderolabs/talos:v1.11.2")
...
```
  ...
  -h, --help                                     help for config
      ...
      --install-image string                     the image used to perform an installation (default "ghcr.io/siderolabs/installer:v1.11.2")
      --kubernetes-version string                desired kubernetes version to run (default "1.34.1")
