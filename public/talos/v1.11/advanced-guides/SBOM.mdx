...
* Download the SBOM for a specific Talos Linux release from the <a href={`https://github.com/siderolabs/talos/releases/tag/${release_v1_11}`}> GitHub release</a> page:
...
172.20.0.2   runtime     SBOMItem   Talos           1         ${release_v1_11}
...
<CodeBlock lang="sh">
{`
docker run --rm --pull always ghcr.io/siderolabs/generate-vex:latest gen --target-version ${release_v1_11} > vex.json
...
`}
</CodeBlock>
