...
canonical: https://docs.siderolabs.com/talos/latest/configure-your-talos-cluster/hardware-and-drivers/nvidia-fabricmanager
---
...
import { release_v1_11, nvidia_driver_release_v1_11, nvidia_container_toolkit_release_v1_11 } from '/snippets/custom-variables.mdx';
...
<CodeBlock lang="sh">
{`
ghcr.io/siderolabs/nvidia-open-gpu-kernel-modules-lts:${nvidia_driver_release_v1_11}-${release_v1_11}
ghcr.io/siderolabs/nvidia-container-toolkit-lts:${nvidia_driver_release_v1_11}-${nvidia_container_toolkit_release_v1_11}
ghcr.io/siderolabs/nvidia-fabricmanager:${nvidia_driver_release_v1_11}
