...
<CodeBlock lang="sh">
{`
curl -fsSLO "https://raw.githubusercontent.com/siderolabs/docs/main/static/talos/${version_v1_11}/gcp/config.yaml"
curl -fsSLO "https://raw.githubusercontent.com/siderolabs/docs/main/static/talos/${version_v1_11}/gcp/talos-ha.jinja"
# if using ccm
curl -fsSLO "https://raw.githubusercontent.com/siderolabs/docs/main/static/talos/${version_v1_11}/gcp/gcp-ccm.yaml"
`}
</CodeBlock>
