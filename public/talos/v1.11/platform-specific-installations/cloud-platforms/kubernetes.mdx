...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/cloud-platforms/kubernetes
---
...
<CodeBlock lang="sh">
{`ghcr.io/siderolabs/talos:${release_v1_11}`}
</CodeBlock>
...
env:
  - name: PLATFORM
    value: container
image: ghcr.io/siderolabs/talos:${release_v1_11}
ports:
  - containerPort: 50000
    name: talos-api
    protocol: TCP
