...
1. **Download the image disk** of the Talos version you wish to run:
  ...
  <CodeBlock lang="sh">
    {`
   wget "https://factory.talos.dev/image/18d0321d7fb289f707a76e1deeaa5c97e62209722cbf4bc533a5d51eb666885f/v1.12.0/scaleway-amd64.raw.zst"
   `}
   </CodeBlock>
...
4. Name the snapshot "scaleway-amd64-v1.12", and use a Local Storage snapshot type.
