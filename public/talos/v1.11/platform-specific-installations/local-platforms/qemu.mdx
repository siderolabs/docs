...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/local-platforms/qemu
---
...
For example version ${release_v1_11} on `amd64` platform:

<CodeBlock lang="sh">
  {`
  curl https://github.com/siderolabs/talos/releases/download/${release_v1_11}/vmlinuz-amd64 -L -o _out/vmlinuz-amd64
  curl https://github.com/siderolabs/talos/releases/download/${release_v1_11}/initramfs-amd64.xz -L -o _out/initramfs-amd64.xz
  `}
</CodeBlock>
...
Cluster provisioning process can be optimized with [registry pull-through caches](../../configure-your-talos-cluster/images-container-runtime/pull-through-cache).
