...
The easiest way to get started with SecureBoot is to download the <a href={`https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_11}/metal-amd64-secureboot.iso`}>
  ISO
</a>, and
...
<CodeBlock lang="sh">
{`
factory.talos.dev/installer-secureboot/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba:${release_v1_11}.
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
talosctl gen config <cluster-name> https://<endpoint>:6443 --install-image=factory.talos.dev/installer-secureboot/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba:${release_v1_11} --install-disk=/dev/sda --config-patch @tpm-disk-encryption.yaml
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
$ docker run --rm -t -v $PWD/_out:/secureboot:ro -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_11} secureboot-iso
profile ready:
arch: amd64
platform: metal
secureboot: true
...
<CodeBlock lang="sh">
{`
$ docker run --rm -t -v $PWD/_out:/secureboot:ro -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_11} secureboot-installer
profile ready:
arch: amd64
platform: metal
secureboot: true
...
<CodeBlock lang="sh">
{`
crane push _out/installer-amd64-secureboot.tar ghcr.io/<user>/installer-amd64-secureboot:${release_v1_11}
`}
</CodeBlock>
