...
<code>
{`https://pxe.factory.talos.dev/pxe/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_11}/equinixMetal-amd64`}
</code>

This URL references the default schematic for Talos version **{release_v1_11}** with an `amd64` architecture.
...
metal device create
  ...
  --ipxe-script-url "https://pxe.factory.talos.dev/pxe/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_11}/equinixMetal-amd64" \\ 
  --plan $PLAN \\ 
  --hostname $HOSTNAME \\ 
...
e.g. <code>{`metal device create -p <projectID> -f da11 -O custom_ipxe -P c3.small.x86 -H steve.test.11 --userdata-file ./controlplane.yaml --ipxe-script-url "https://pxe.factory.talos.dev/pxe/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_11}/equinixMetal-amd64"`}</code>
