...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/single-board-computers/orangepi_5
---
...
<CodeBlock lang="sh">
  {`
curl -LO https://factory.talos.dev/image/[uuid]/${release_v1_11}/metal-arm64.raw.xz
