...
```shell
talosctl upgrade \
  --image factory.talos.dev/metal-installer/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176:<new_version>
```
...
talosctl upgrade --image \\
  factory.talos.dev/metal-installer/<new_schematic_id>:${release_v1_11}
`}
</CodeBlock>
...
```shell
talosctl upgrade --image \
  factory.talos.dev/metal-installer/0db665edfda21c70194e7ca660955425d16cec2aa58ff031e2abf72b7c328585:<new_version>
```
...
{`
curl -LO \\
  https://factory.talos.dev/image/d9ff89777e246792e7642abd3220a616afb4e49822382e4213a2e528ab826fe5/${release_v1_11}/aws-amd64.raw.xz
`}
</CodeBlock>
...
talosctl upgrade --image \\
  factory.talos.dev/aws-installer/d9ff89777e246792e7642abd3220a616afb4e49822382e4213a2e528ab826fe5:<new_version>

# upgrade to a new schematic
talosctl upgrade --image \\
  factory.talos.dev/aws-installer/<new_schematic_id>:v1.11.0
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
crane export ghcr.io/siderolabs/extensions:${release_v1_11}  \\
...
<CodeBlock lang="sh">
{`
crane export ghcr.io/siderolabs/overlays:${release_v1_11} \\
...
docker run --rm -t \\
  ...
  ghcr.io/siderolabs/imager:${release_v1_11} \\
  iso \\
  --system-extension-image ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_11}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e \\
...
**Generate the initramfs image (with system extensions):**
...
crane push _out/metal-amd64-installer.tar \\
  ghcr.io/<username></username>/installer:${release_v1_11}
`}
</CodeBlock>
...
```shell
crane export \
  <your-private-registry>/<your-extension>:latest \
  <your-extension>
```
