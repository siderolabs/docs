...
<CodeBlock language="bash">{`AMI=$(curl -sL https://github.com/siderolabs/talos/releases/download/${release_v1_6}/cloud-images.json | \
...
<CodeBlock lang="sh">
{`
curl -L https://github.com/siderolabs/talos/releases/download/${release_v1_6}/aws-amd64.raw.xz | xz -d > disk.raw
`}
</CodeBlock>
