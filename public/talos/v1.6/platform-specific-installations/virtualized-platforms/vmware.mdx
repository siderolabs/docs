...
<CodeBlock lang="sh">
  {`
curl -fsSLO https://raw.githubusercontent.com/siderolabs/docs/main/static/talos/${version_v1_6}/vmware/cp.patch.yaml
  `}
</CodeBlock>
...
<CodeBlock lang="sh">
  {`
curl -fsSL "https://raw.githubusercontent.com/siderolabs/docs/main/static/talos/${version_v1_6}/vmware/vmware.sh" | sed s/latest/${release_v1_6 }/ > vmware.sh
  `}
</CodeBlock>
