...
canonical: https://docs.siderolabs.com/talos/latest/learn-more/components
---
...
![Talos Linux and Kubernetes components](./images/components-talos-linux-components.svg)
