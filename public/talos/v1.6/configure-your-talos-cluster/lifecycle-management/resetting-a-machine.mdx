...
canonical: https://docs.siderolabs.com/talos/latest/configure-your-talos-cluster/lifecycle-management/resetting-a-machine
---
...
It might be more useful to just wipe the [STATE](../../learn-more/architecture#file-system-partitions) and [EPHEMERAL](../../learn-more/architecture#file-system-partitions) partitions on a cloud VM if not booting via `iPXE`.
