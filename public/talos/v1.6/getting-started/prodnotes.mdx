...
canonical: https://docs.siderolabs.com/talos/latest/getting-started/prodnotes
---
...
- X86: <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_6 }/vmlinuz-amd64`}>vmlinuz-amd64</a> <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_6 }/initramfs-amd64.xz`}>initramfs-amd64.xz</a>
- ARM64: <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_6 }/vmlinuz-arm64`}>vmlinuz-arm64</a> <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_6 }/initramfs-arm64.xz`}>initramfs-arm64.xz</a>
...
See [required kernel parameters](../reference/kernel).

Similarly, if creating [EC2 kubernetes clusters](../platform-specific-installations/cloud-platforms/aws), the configuration file can be passed in as `--user-data` to the `aws ec2 run-instances` command.
See generally the [Installation Guide](../platform-specific-installations/bare-metal-platforms/digital-rebar) for the platform being deployed.
...
Other modifications are done with [machine configuration patches](../configure-your-talos-cluster/system-configuration/patching).
...
different [static IP address](../networking/advanced-networking#static-addressing).
...
For a list of all the commands and operations that `talosctl` provides, see the [CLI reference](../reference/cli).
