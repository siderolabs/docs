...
import { release_v1_6 , k8s_release } from '/snippets/custom-variables.mdx';
...
talos-default-controlplane-1   Ready    master   115s   v${k8s_release}   10.5.0.2      <none>        Talos ${release_v1_6 }   <host kernel>    containerd://1.5.5
talos-default-worker-1         Ready    <none>   115s   v${k8s_release}   10.5.0.3      <none>        Talos ${release_v1_6 }   <host kernel>    containerd://1.5.5
`}
</CodeBlock>
