...
canonical: https://docs.siderolabs.com/talos/latest/getting-started/what's-new-in-talos
---
...
All other release assets can be downloaded from [Image Factory](../platform-specific-installations/boot-assets#image-factory).
