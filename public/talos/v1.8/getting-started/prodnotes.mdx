...
- X86: <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_8}/vmlinuz-amd64`}>vmlinuz-amd64</a> <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_8}/initramfs-amd64.xz`}>initramfs-amd64.xz</a>
- ARM64: <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_8}/vmlinuz-arm64`}>vmlinuz-arm64</a> <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_8}/initramfs-arm64.xz`}>initramfs-arm64.xz</a>
...
See generally the [Installation Guide](../platform-specific-installations/bare-metal-platforms/equinix-metal) for the platform being deployed.
