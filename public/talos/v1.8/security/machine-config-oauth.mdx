...
canonical: https://docs.siderolabs.com/talos/latest/security/machine-config-oauth
---
...
The list of variables supported by the `talos.config.oauth.extra_variable` parameter is same as the [list of variables](../reference/kernel#talosconfig) supported by the `talos.config` parameter.
