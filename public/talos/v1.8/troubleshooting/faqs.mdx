...
canonical: https://docs.siderolabs.com/talos/latest/troubleshooting/faqs
---
...
To renew the `talosconfig` certificate, the follow [this process](../security/cert-management).
To renew `kubeconfig`, use `talosctl kubeconfig` command, and the time-to-live (TTL) is defined in the [configuration](../reference/configuration/overview).
