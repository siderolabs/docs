...
canonical: https://docs.siderolabs.com/talos/latest/security/iam-roles-for-service-accounts
---
...
- `AWS_ACCOUNT`: Your 12-digit AWS account ID. [Need help finding it?](https://docs.aws.amazon.com/IAM/latest/UserGuide/console-account-id.html)
- `AWS_REGION`: The AWS region where you will create resources. [Need help choosing one?](https://docs.aws.amazon.com/global-infrastructure/latest/regions/aws-regions.html)
