...
canonical: https://docs.siderolabs.com/talos/latest/security/cert-management
---
...
[generating machine configuration](../getting-started/getting-started#configure-talos):
