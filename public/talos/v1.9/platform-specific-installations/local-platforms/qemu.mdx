...
For example version {release_v1_9}:

<CodeBlock lang="sh">
  {`
  curl https://github.com/siderolabs/talos/releases/download/${release_v1_9}/vmlinuz-amd64 -L -o _out/vmlinuz-amd64
  curl https://github.com/siderolabs/talos/releases/download/${release_v1_9}/initramfs-amd64.xz -L -o _out/initramfs-amd64.xz
  `}
</CodeBlock>
