...
<CodeBlock lang="sh">
{`
AMI=$(curl -sL https://github.com/siderolabs/talos/releases/download/${release_v1_9}/cloud-images.json | \
...
<CodeBlock lang="sh">
{`curl -L https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_9}/aws-amd64.raw.xz | xz -d > disk.raw`}
</CodeBlock>
