...
<CodeBlock lang="sh">
{`
$ docker run --rm -i ghcr.io/siderolabs/imager:${release_v1_9} iso --arch amd64 --tar-to-stdout --extra-kernel-arg console=ttyS1 --extra-kernel-arg console=tty0 | tar xz
