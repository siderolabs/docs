...
- X86: <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_9}/vmlinuz-amd64`}>vmlinuz-amd64</a> <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_9}/initramfs-amd64.xz`}>initramfs-amd64.xz</a>
- ARM64: <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_9}/vmlinuz-arm64`}>vmlinuz-arm64</a> <a href={`https://github.com/siderolabs/talos/releases/download/${release_v1_9}/initramfs-arm64.xz`}>initramfs-arm64.xz</a>
...
See generally the [Installation Guide](../platform-specific-installations/bare-metal-platforms/bootloader) for the platform being deployed.
