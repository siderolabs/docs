...
<CodeBlock lang="sh">{`git checkout ${release_v1_10}`}</CodeBlock>
...
Talos images for CPUs that don't meet the default [x86-64-v2 requirement](../../getting-started/system-requirements#cpu-architecture):
