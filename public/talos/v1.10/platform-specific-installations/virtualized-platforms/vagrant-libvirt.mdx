...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/virtualized-platforms/vagrant-libvirt
---
...
<CodeBlock lang="sh">
  {`
wget --timestamping curl https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_10}/metal-amd64.iso -O /tmp/metal-amd64.iso
  `}
</CodeBlock>
