...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/virtualized-platforms/proxmox
---
...
For example version {release_v1_10 } for `linux` platform:

<CodeBlock lang="sh">
  {`
mkdir -p _out/
curl https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_10}/metal-amd64.iso -L -o _out/metal-amd64.iso
  `}
</CodeBlock>
...
- Scroll down and select your Talos version ( {release_v1_10} for example)
...
amd64 ISO
    https://factory.talos.dev/image/ce4c980550dd2ab1b17bbf2b08801c7eb59418eafe8f279833297925d67c7515/${release_v1_10}/metal-amd64.iso
arm64 ISO
    https://factory.talos.dev/image/ce4c980550dd2ab1b17bbf2b08801c7eb59418eafe8f279833297925d67c7515/${release_v1_10}/metal-arm64.iso

Installer Image

For the initial Talos install or upgrade use the following installer image:
factory.talos.dev/installer/ce4c980550dd2ab1b17bbf2b08801c7eb59418eafe8f279833297925d67c7515:${release_v1_10}
  `}
</CodeBlock>
...
<CodeBlock lang="sh">
  {`
talosctl gen config talos-proxmox-cluster https://$CONTROL_PLANE_IP:6443 --output-dir _out --install-image factory.talos.dev/installer/ce4c980550dd2ab1b17bbf2b08801c7eb59418eafe8f279833297925d67c7515:${release_v1_10}
  `}
</CodeBlock>
