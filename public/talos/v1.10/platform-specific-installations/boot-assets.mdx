...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/boot-assets
---
...
* using custom `META` contents, e.g. for [metal network configuration](../networking/metal-network-configuration)
...
* <a href={`https://factory.talos.dev/image/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176/${release_v1_10}/metal-amd64.iso`}>
    using ISO image (download it and burn to a CD/DVD or USB stick)
  </a> 

* <a href={`https://factory.talos.dev/pxe/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176/${release_v1_10}/metal-amd64`}>
...
machine:
  install:
    image: factory.talos.dev/metal-installer/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176:${release_v1_10}
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
talosctl upgrade --image factory.talos.dev/metal-installer/<new_schematic_id>:${release_v1_10}
`}
</CodeBlock>
...
Now we can [download the metal arm64 image](https://factory.talos.dev/image/0db665edfda21c70194e7ca660955425d16cec2aa58ff031e2abf72b7c328585/${release_v1_10}/metal-arm64.raw.xz) (download it and burn to a boot media)
...
<CodeBlock lang="sh">
{`
curl -LO https://factory.talos.dev/image/d9ff89777e246792e7642abd3220a616afb4e49822382e4213a2e528ab826fe5/${release_v1_10}/aws-amd64.raw.xz
`}
</CodeBlock>

Now the `aws-amd64.raw.xz` file contains the customized Talos AWS disk image which can be uploaded as an AMI to the [AWS](./cloud-platforms/aws).
...
talosctl upgrade --image factory.talos.dev/aws-installer/<new_schematic_id>:${release_v1_10}
`}
</CodeBlock>

## Imager

A custom disk image, boot asset can be generated by using the Talos Linux `imager` container: ghcr.io/siderolabs/imager:{release_v1_10}.
...
<CodeBlock lang="sh">
{`
docker run --rm -t -v $PWD/_out:/secureboot:ro -v $PWD/_out:/out -v /dev:/dev --privileged ghcr.io/siderolabs/imager:${release_v1_10} <image-kind> [optional: customization]
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
crane export ghcr.io/siderolabs/extensions:${release_v1_10} | tar x -O image-digests | grep EXTENSION-NAME
`}
</CodeBlock>

<Note> This command is using [crane](https://github.com/google/go-containerregistry/blob/main/cmd/crane/README.md) tool, but any other tool which allows to export the image contents can be used. </Note>
...
<CodeBlock lang="sh">
{`
crane export ghcr.io/siderolabs/overlays:${release_v1_10} | tar x -O overlays.yaml
`}
</CodeBlock>
...
<Tabs>
  <Tab title="Command">
    <CodeBlock lang="sh">
      {`
      crane export ghcr.io/siderolabs/extensions:${release_v1_10} | tar x -O image-digests | grep -E 'gvisor|intel-ucode'
      `}
    </CodeBlock>
  </Tab>
  <Tab title="Output">
    <CodeBlock lang="sh">
      {`
        ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_10}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e
...
<Tabs>
  <Tab title="Command">
    <CodeBlock lang="sh">
      {`
        docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_10} iso --system-extension-image ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_10}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e --system-extension-image ghcr.io/siderolabs/intel-ucode:20231114@sha256:ea564094402b12a51045173c7523f276180d16af9c38755a894cf355d72c249d --extra-kernel-arg net.ifnames=0 --extra-kernel-arg=-console --extra-kernel-arg=console=ttyS1
        `}
      </CodeBlock>
    </Tab>
  <Tab title="Output">
    <CodeBlock lang="sh">
      ...
      input:
        ...
        baseInstaller:
          imageRef: ghcr.io/siderolabs/installer:${release_v1_10}
        systemExtensions:
          - imageRef: ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_10}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e
...
<CodeBlock lang="sh">
{`
docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_10} iso --output-kind kernel
docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_10} iso --output-kind initramfs --system-extension-image ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_10}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e --system-extension-image ghcr.io/siderolabs/intel-ucode:20231114@sha256:ea564094402b12a51045173c7523f276180d16af9c38755a894cf355d72c249d
`}
</CodeBlock>

Now the `_out/kernel-amd64` and `_out/initramfs-amd64` contain the customized Talos kernel and initramfs images.

<Note>The extra kernel args are not used now, as they are set via the PXE boot process, and can't be embedded into the kernel or initramfs.</Note>
...
<CodeBlock lang="sh">
{`
docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_10} installer --platform=metal --system-extension-image ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_10}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e --system-extension-image ghcr.io/siderolabs/intel-ucode:20231114@sha256:ea564094402b12a51045173c7523f276180d16af9c38755a894cf355d72c249d
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
crane push _out/metal-amd64-installer.tar ghcr.io/<username></username>/installer:${release_v1_10}
`}
</CodeBlock>
...
<Tabs>
  <Tab title="Command">
    <CodeBlock lang="sh">
      {`
        crane export ghcr.io/siderolabs/extensions:${release_v1_10} | tar x -O image-digests | grep -E 'iscsi-tools'
      `}
    </CodeBlock>
  </Tab>
  <Tab title="Output">
...
<Tabs>
  <Tab title="Command">
    <CodeBlock lang="sh">
      {`
        crane export ghcr.io/siderolabs/overlays:${release_v1_10} | tar x -O overlays.yaml | yq '.overlays[] | select(.name=="rpi_generic")'
      `}
    </CodeBlock>
  </Tab>
  <Tab title="Output">
...
<CodeBlock lang="sh">
{`
docker run --rm -t -v $PWD/_out:/out ghcr.io/siderolabs/imager:${release_v1_10} installer --arch arm64 --system-extension-image ghcr.io/siderolabs/iscsi-tools:v0.1.4@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e --overlay-image ghcr.io/siderolabs/sbc-raspberrypi:v0.1.0@sha256:849ace01b9af514d817b05a9c5963a35202e09a4807d12f8a3ea83657c76c863 --overlay-name=rpi_generic
`}
</CodeBlock>
...
<CodeBlock lang="sh">
{`
crane push _out/metal-arm64-installer.tar ghcr.io/<username></username>/installer:${release_v1_10}
`}
</CodeBlock>
...
<Tabs>
  <Tab title="Command">
    <CodeBlock lang="sh">
      {`
      crane export ghcr.io/siderolabs/extensions:${release_v1_10} | tar x -O image-digests | grep gvisor
      `}
    </CodeBlock>
  </Tab>
  <Tab title="Output">
...
<CodeBlock lang="sh">
{`
docker run --rm -t -v $PWD/_out:/out -v /dev:/dev --privileged ghcr.io/siderolabs/imager:${release_v1_10} aws --system-extension-image ghcr.io/siderolabs/gvisor:20231214.0-${release_v1_10}@sha256:548b2b121611424f6b1b6cfb72a1669421ffaf2f1560911c324a546c7cee655e
`}
</CodeBlock>

Now the `_out/aws-amd64.raw.xz` contains the customized Talos AWS disk image which can be uploaded as an AMI to the [AWS](./cloud-platforms/aws).
...
ghcr.io/siderolabs/imager:${release_v1_10} -
`}
</CodeBlock>