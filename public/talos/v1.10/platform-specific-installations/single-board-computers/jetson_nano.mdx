...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/single-board-computers/jetson_nano
---
...
<CodeBlock lang="sh">
  {`
curl -LO https://factory.talos.dev/image/c7d6f36c6bdfb45fd63178b202a67cff0dd270262269c64886b43f76880ecf1e/${release_v1_10}/metal-arm64.raw.xz
...
<CodeBlock lang="sh">
  {`
talosctl -n <node IP or DNS name> upgrade --image=factory.talos.dev/installer/c7d6f36c6bdfb45fd63178b202a67cff0dd270262269c64886b43f76880ecf1e:${release_v1_10}
  `}
</CodeBlock>
