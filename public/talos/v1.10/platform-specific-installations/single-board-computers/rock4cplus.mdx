...
canonical: https://docs.siderolabs.com/talos/latest/platform-specific-installations/single-board-computers/rock4cplus
---
...
<CodeBlock lang="sh">
  {`
curl -LO https://factory.talos.dev/image/ed7091ab924ef1406dadc4623c90f245868f03d262764ddc2c22c8a19eb37c1c/${release_v1_10}/metal-arm64.raw.xz
...
<CodeBlock lang="sh">
  {`
talosctl -n <node IP or DNS name> upgrade --image=factory.talos.dev/installer/ed7091ab924ef1406dadc4623c90f245868f03d262764ddc2c22c8a19eb37c1c:${release_v1_10}
  `}
</CodeBlock>
