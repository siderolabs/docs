...
import { release_v1_10, nvidia_driver_release_v1_10, nvidia_container_toolkit_release_v1_10 } from '/snippets/custom-variables.mdx';
...
<CodeBlock lang="sh">
{`
ghcr.io/siderolabs/nvidia-open-gpu-kernel-modules-lts:${nvidia_driver_release_v1_10}-${release_v1_10}
ghcr.io/siderolabs/nvidia-container-toolkit-lts:${nvidia_driver_release_v1_10}-${nvidia_container_toolkit_release_v1_10}
ghcr.io/siderolabs/nvidia-fabricmanager:${nvidia_driver_release_v1_10}
