...
Each Talos version has a corresponding installer image, listed on the release page for the version, for example <a href={`https://github.com/siderolabs/talos/releases/tag/${release_v1_10}`}>{release_v1_10}</a>.
...
## Before Upgrade to {release_v1_10}
...
## After Upgrade to {release_v1_10}
...
{`
  ...
  --image ghcr.io/siderolabs/installer:${release_v1_10}
`}
</CodeBlock>
