...
canonical: https://docs.siderolabs.com/talos/latest/configure-your-talos-cluster/images-container-runtime/image-cache
---
...
{`
mkdir -p _out/
docker run --rm -t -v $PWD/_out:/secureboot:ro -v $PWD/_out:/out -v $PWD/image-cache.oci:/image-cache.oci:ro -v /dev:/dev --privileged ghcr.io/siderolabs/imager:${release_v1_10} iso --image-cache /image-cache.oci
`}
</CodeBlock>
...
{`
mkdir -p _out/
docker run --rm -t -v $PWD/_out:/secureboot:ro -v $PWD/_out:/out -v $PWD/image-cache.oci:/image-cache.oci:ro -v /dev:/dev --privileged ghcr.io/siderolabs/imager:${release_v1_10} metal --image-cache /image-cache.oci
`}
</CodeBlock>
...
See [disk management](../storage-and-disk-management/disk-management#machine-configuration) for more information on volume configuration.
