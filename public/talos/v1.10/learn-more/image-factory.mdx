...
canonical: https://docs.siderolabs.com/talos/latest/learn-more/image-factory
---
...
See [Boot Assets](../platform-specific-installations/boot-assets#image-factory) for an example of how to use the Image Factory to boot and upgrade Talos on different platforms.
...
* <a href={`https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_10}/metal-amd64.iso`}> amd64 ISO (for Talos {release_v1_10}, "vanilla" schematic) </a>

*  <a href={`https://factory.talos.dev/image/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_10}/aws-arm64.raw.xz`}> arm64 AWS image (for Talos {release_v1_10}, "vanilla" schematic) </a>

* <a href={`https://pxe.factory.talos.dev/pxe/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba/${release_v1_10}/metal-amd64`}> amd64 PXE boot script (for Talos {release_v1_10}, "vanilla" schematic)  </a>

* Talos `<code>` installer image (for Talos {release_v1_10}, “vanilla” schematic, architecture is detected automatically):  

<CodeBlock lang="sh">
{`factory.talos.dev/installer/376567988ad370138ad8b2698212367b8edcb69b5fd68c80be1f2ec7d603b4ba:${release_v1_10}`}
</CodeBlock>
...
* `installer` container images (base installer layer)
