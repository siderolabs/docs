...
KubePrism is enabled by default on port 7445, so most clusters won't need any additional configuration. If you do want to customize it, use the following `machine.features.kubePrism` configuration block:
