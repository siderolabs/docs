...
* <a href={`https://factory.talos.dev/image/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176/${release_v1_13}/metal-amd64.iso`}>
    using ISO image (download it and burn to a CD/DVD or USB stick)
  </a>

* <a href={`https://factory.talos.dev/pxe/b8e8fbbe1b520989e6c52c8dc8303070cb42095997e76e812fa8892393e1d176/${release_v1_13}/metal-amd64`}>
...
talosctl upgrade \\
  --image \\
  factory.talos.dev/metal-installer/<new_schematic_id>:${release_v1_13}
`}
</CodeBlock>
...
talosctl upgrade \\
  --image \\
  factory.talos.dev/aws-installer/<new_schematic_id>:${release_v1_13}
`}
</CodeBlock>
...
crane push _out/metal-amd64-installer.tar \\
  ghcr.io/<username></username>/installer:${release_v1_13}
`}
</CodeBlock>
