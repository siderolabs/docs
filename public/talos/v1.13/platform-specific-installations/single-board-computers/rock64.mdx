...
<CodeBlock lang="sh">
  {`
curl -LO https://factory.talos.dev/image/0e162298269125049a51ec0a03c2ef85405a55e1d2ac36a7ef7292358cf3ce5a/${release_v1_13}/metal-arm64.raw.xz
...
<CodeBlock lang="sh">
  {`
talosctl -n <node IP or DNS name> upgrade --image=factory.talos.dev/installer/0e162298269125049a51ec0a03c2ef85405a55e1d2ac36a7ef7292358cf3ce5a:${release_v1_13}
  `}
</CodeBlock>
