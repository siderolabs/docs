...
<CodeBlock lang="sh">
  {`
curl -LO https://factory.talos.dev/image/5f74a09891d5830f0b36158d3d9ea3b1c9cc019848ace08ff63ba255e38c8da4/${release_v1_13}/metal-arm64.raw.xz
...
<CodeBlock lang="sh">
  {`
talosctl -n <node IP or DNS name> upgrade --image=factory.talos.dev/installer/5f74a09891d5830f0b36158d3d9ea3b1c9cc019848ace08ff63ba255e38c8da4:${release_v1_13}
  `}
</CodeBlock>