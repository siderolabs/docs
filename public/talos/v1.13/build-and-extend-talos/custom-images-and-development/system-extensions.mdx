...
canonical: https://docs.siderolabs.com/talos/latest/build-and-extend-talos/custom-images-and-development/system-extensions
---
...
<iframe width="560"
    height="315"
    src="https://www.youtube.com/embed/yu30AZ8g5LU"
    title="Use and Create Talos Linux System Extensions"
    frameborder="0"
    allow="accelerometer;
...
<Note>You can view the full catalog of available extensions and their respective support tiers in the [Extension Catalog on GitHub](https://github.com/siderolabs/extensions#extension-catalog).</Note>
...
There are several kinds of boot assets that Talos can generate:
...
The process of generating boot assets with extensions included is described in the [boot assets guide](../../platform-specific-installations/boot-assets).

### Example: Boot from an ISO
...
## Author system extensions

A Talos system extension is a container image with the [specific folder structure](https://github.com/siderolabs/extensions?tab=readme-ov-file#building-extensions).
