...
canonical: https://docs.siderolabs.com/talos/latest/build-and-extend-talos/cluster-operations-and-maintenance/etcd-maintenance
---
...
This procedure is described in the [disaster recovery](./disaster-recovery) guide.

## Downgrade v3.6 to v3.5

Before beginning, check the `etcd` health and download snapshot, as described in [disaster recovery](./disaster-recovery).
...
[Download the snapshot backup](./disaster-recovery) to provide a downgrade path should any problems occur.
...
### Step 5: Patch machine configuration
