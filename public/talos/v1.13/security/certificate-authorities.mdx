...
canonical: https://docs.siderolabs.com/talos/latest/security/certificate-authorities
---
...
Please note that if the `STATE` partition is encrypted, the CA certificates will only be loaded after the partition is unlocked.
