...
KubePrism is enabled by default on port 7445, so most clusters require no additional configuration. If you do need to customize it, use the [`KubePrismConfig`](../../talos/v1.14/reference/configuration/kubernetes/kubeprismconfig) document:
