...
First, we will create a separate <a href= "../../talos/${version}/configure-your-talos-cluster/storage-and-disk-management/disk-management/user">user volume</a> for the Local Path Provisioner to use.
