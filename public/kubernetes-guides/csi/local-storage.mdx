...
The simplest way to do this is to configure <a href={`../../talos/${version}/configure-your-talos-cluster/storage-and-disk-management/disk-management/user`}>user volumes</a> for Local Path Provisioner to use.
