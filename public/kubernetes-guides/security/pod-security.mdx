...
## Default PSA calicoonfiguration
...
**What’s happening**: Your pod does not comply with the `restricted` profile. For example, the pod either allows privilege escalation or doesn’t force non-root user.
