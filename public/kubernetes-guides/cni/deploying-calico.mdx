...
description: "In this guide you will learn how to set up Calico CNI on Talos."
aliases:
...
Calico features a pluggable dataplane architecture that allows you to choose the networking technology best suited to your use case.

The networking technology serves as the backend that enables your nodes to transfer packets between sources, destinations, and your Kubernetes resources.

Changing dataplane is as easy as changing the linuxDataplane value within the installation resources.
