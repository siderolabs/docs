...
1. Ensure you are in your project's directory and apply the `etcd-metrics-patch.yaml` patch to your control plane nodes.
    ...
    **Note**: You can also [export your `TALOSCONFIG` variable](../../talos/v1.10/getting-started/prodnotes.mdx#step-11-manage-your-talos-configuration-file") and then remove the `--talosconfig=./talosconfig` flag in the patch command above.
...
See the [Ingress Firewall guide](../../talos/v1.10/networking/ingress-firewall.mdx) for instructions on securing your control plane.
