...
The simplest way to use local storage is to use [user volumes](../../talos/v1.11/configure-your-talos-cluster/storage-and-disk-management/disk-management/user.mdx).
